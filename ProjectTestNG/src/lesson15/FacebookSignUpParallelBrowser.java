...
public class FacebookSignUpParallelBrowser {
	...
	public void setUp(String browser) {
		...
		if (browser.equalsIgnoreCase("Chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:/ProSmart Automation Module with Mahfuz/Tools/chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browser.equalsIgnoreCase("Edge")) {
			System.setProperty("webdriver.edge.driver", "C:/ProSmart Automation Module with Mahfuz/Tools/msedgedriver.exe");
	...
	public void verifyErrorMessage() {
		WebElement errorField = new WebDriverWait(driver, Duration.ofSeconds(30)).

...
public class FacebookSignUpTestNG_Test {
	...
	public void openBrowser() {
		System.setProperty("webdriver.chrome.driver",
				"C:\\ProSmart Automation Module with Mahfuz\\Tools\\chromedriver.exe");
	...
	public void verifyErrorMessage() {
		WebElement errorField = driver.findElement(By.xpath("//div[@id='reg_error_inner']"));
		String actualError = errorField.getText(); // message would not be picked up as it takes time to populate. Put
													// some wait there
...
//WebElement errorField = new WebDriverWait(driver, Duration.ofSeconds(45)).
//until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='reg_error_inner']"))); 
//soft.assertAll();//this is required after the end of every soft assert. 
